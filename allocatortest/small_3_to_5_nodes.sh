...
# This test starts with a 3-node cluster containing 10G of data. It then adds
# 2 nodes to the cluster and measures how long it takes to rebalance replicas
# across the cluster.

# These control the GCE instance configs and naming of Terraform resources.
# Please prefix these with "${USER}-".
NAME_PREFIX="${USER}-small-3to5"
